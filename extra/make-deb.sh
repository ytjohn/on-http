...
java -jar ./swagger-codegen/modules/swagger-codegen-cli/target/swagger-codegen-cli.jar generate -i static/monorail-2.0.yaml \ 
  -o on-http-api2.0 -l python --additional-properties packageName=on_http_api2_0
java -jar ./swagger-codegen/modules/swagger-codegen-cli/target/swagger-codegen-cli.jar generate -i static/redfish.yaml \ 
  -o on-http-redfish-1.0 -l python --additional-properties packageName=on_http_redfish_1_0
